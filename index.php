    ...
    <section class="cover overflow-hidden bg-black inverted">
        <div class="d-flex flex-column py-20 min-vh-100 container foreground">
            <div class="row justify-content-center my-auto">
                <div class="col-md-10 text-center">
                    <h1 class="fw-bold display-1">We are a trading and financing consulting company.</h1>
                    <a href="get-started" class="btn btn-white rounded-pill">Get Started</a>
                </div>
            </div>
        </div>
        <div class="background background-overlay text-black" data-aos="zoom-out" data-aos-delay="200">
            <video playsinline autoplay muted loop data-video>
                <source src="https://cube.webuildthemes.com/assets/video/video-3.mp4" type="video/mp4" />
            </video>
        </div>
        ...
        <div class="container">
          <div class="row align-items-center justify-content-between">
            ...
            <div class="col-lg-6 col-xl-5">
              ...
              <p class="text-secondary">Forethought kənˈsəlt. works with finders that provides customized funding solutions from $1 million to $100 billon across the capital stack. Project funding for real estate, energy, infrastructure, hospitality and more at very low Interest rate.</p>
            </div>
          </div>
        </div>
    </section>
                  ...
                  <div class="accordion" id="accordion-1">
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="heading-1-8">
                        <button class="accordion-button lead collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1-8" aria-expanded="false" aria-controls="collapse-1-8">
                          Small Business 
                        </button>
                      </h2>
                      <div id="collapse-1-8" class="accordion-collapse collapse" aria-labelledby="heading-1-8" data-bs-parent="#accordion-1" style="">
                        <div class="accordion-body">
                          <ul>
        ...
        <div class="container level-1">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-xl-6 text-center">
                    ...
                    <a href="get-started" class="btn btn-with-icon btn-yellow">Get Started <i class="bi bi-arrow-right"></i></a>
                </div>
            </div>
        </div>
